<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      ...
      <div id="collapseTourType" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{ route('types.index') }}">{{ trans('language.tourTypeList') }}</a>
          <a class="collapse-item" href="{{ route('types.create') }}">{{ trans('language.tourTypeAdd') }}</a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">{{ trans('language.functioning') }}</h6>
          <a class="collapse-item" href="{{ route('bookings.index') }}">{{ trans('language.bookingRequestList') }}</a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div id="collapseOrder" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">{{ trans('language.functioning') }}</h6>
          <a class="collapse-item" href="{{ route('reviews.index') }}">{{ trans('language.userReviewList') }}</a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div id="collapseRevenue" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">{{ trans('language.functioning') }}</h6>
          <a class="collapse-item" href="{{ route('revenues.index') }}">{{ trans('language.revenueList') }}</a>
          <a class="collapse-item" href="{{ route('revenues.create') }}">{{ trans('language.revenueAdd') }}</a>
        </div>
      </div>
    </li>
    <!-- Divider -->
